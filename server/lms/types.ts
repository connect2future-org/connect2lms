...
export type StudentTable = { id: number; schoolId: number; teacherId: number; name: string; description: string | null; studentUserIds: number[]; createdAt: Date; updatedAt: Date };
export type AssessmentStatus = "DRAFT" | "PUBLISHED" | "ARCHIVED";
export type Assessment = { id: number; schoolId: number; teacherId: number; title: string; description: string | null; status: AssessmentStatus; resultsPublished?: boolean; startAt: Date; endAt: Date; durationMinutes: number; maxAttempts: number; accessCodeEnabled: boolean; accessCode: string | null; randomizeQuestions: boolean; randomizeOptions: boolean; negativeMarking: boolean; antiCheat: Record<string, unknown>; createdAt: Date; updatedAt: Date };
